...
@section('noidung')
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Lọc số tiền trung bình của người chơi pass level</h1>
        </div>

        <!-- Content Row -->
        <div class="card shadow mb-4">
            <div class="card-body">
                <form action="{{ route('get-locsotiennguoichoipass') }}" method="GET" class="" id="filter-frm">
                    <div class="row">
